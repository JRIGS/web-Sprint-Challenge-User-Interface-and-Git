...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? Semantic Html elements define content clearly as some non-semantic elements like <span> tells nothing about the content.

2. Name two big differences between ```display: block;``` and ```display: inline;```.
Block creates its own space around different elements as inline block goes inside blocks
...
It allows you to work on different sections of one big project with others, new code changes can be easily committed/compared/merged.
